 ...
 */
@JacksonStdImpl
public final class ModifiedStringArrayDeserializer
...
// but for now won't:
    ...
    public final static ModifiedStringArrayDeserializer instance = new ModifiedStringArrayDeserializer();
    ...
    public ModifiedStringArrayDeserializer() {
        this(null, null, null);
    }

    @SuppressWarnings("unchecked")
    protected ModifiedStringArrayDeserializer(JsonDeserializer<?> deser, NullValueProvider nuller, Boolean unwrapSingle) {
        super(String[].class);
    ...
    public JsonDeserializer<?> createContextual(DeserializationContext ctxt, BeanProperty property) throws JsonMappingException {
        ...
        return new ModifiedStringArrayDeserializer(deser, nuller, unwrapSingle);
    }
    ...
    private String[] handleNonArray(JsonParser p, DeserializationContext ctxt) throws IOException {
        if (p.isExpectedStartObjectToken()) {
            ...
            for (; key != null; key = p.nextFieldName()) {
                ...
                try {
                    ...
                    JsonMappingException.wrapWithPath(e, sortedElements, key);
                }
            }

            String[] result = (String[]) Array.newInstance(String.class, sortedElements.size());
            int i = 0;
            for (String value : sortedElements.values()) {
                result[i] = value;
                i++;
            }
            return result;
